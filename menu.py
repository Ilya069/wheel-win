...
def main():
	...
	keyboard.add_line()
	keyboard.add_button('Чётное', color=VkKeyboardColor.PRIMARY)
	keyboard.add_button('На число', color=VkKeyboardColor.PRIMARY)
	keyboard.add_button('Нечётное', color=VkKeyboardColor.PRIMARY)
	keyboard.add_line() 
